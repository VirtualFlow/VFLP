...
cxcalc_tautomerize() {
    ...
    if [ "${last_exit_code}" -ne "0" ]; then
        ...
        pdb_tautomerization_remark="REMARK    This tautomer was generated by cxcalc version ${cxcalc_version} of ChemAxons JChem Suite."
...
obabel_protonate() {
    ...
    if [ "${last_exit_code}" -ne "0" ]; then
        ...
        protonation_success="true"
        pdb_protonation_remark="REMARK    Protonation state was generated at pH ${protonation_pH_value} by Open Babel version ${obabel_version}"
...
obabel_generate_conformation(){
    ...
    if [ "${last_exit_code}" -ne "0" ]; then
        ...
        # Variables
        conformation_success="true"
        pdb_conformation_remark="REMARK    Generation of the 3D conformation was carried out by obabel version ${obabel_version}"
...
obabel_generate_pdb() {
    ...
    if [ "${last_exit_code}" -ne "0" ]; then
        ...
        pdb_generation_remark="REMARK    Generation of the the PDB file (without conformation generation) was carried out by obabel version ${obabel_version}"
...
obabel_generate_targetformat() {
    ...
    if [ "${last_exit_code}" -ne "0" ]; then
        ...
        if [[ "${targetformat}" == "pdbqt" ]]; then
            ...
            # Variables
            pdb_targetformat_remark="REMARK    Generation of the the target format file (${targetformat}) was carried out by obabel version ${obabel_version}"
